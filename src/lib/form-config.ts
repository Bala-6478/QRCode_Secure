...
export const formFieldsConfig: Record<FormType, any[]> = {
    studentBio: [
        ...
        { name: 'fullName', label: 'Full Name', type: 'text', placeholder: "BALAVIGNESH", required: true },
        ...
        { name: 'email', label: 'Email', type: 'email', placeholder: "bala@example.com", required: true },
    ...
    jobApplication: [
        { name: 'password', label: 'Password', type: 'password', placeholder: "Enter a secure password", required: true, span: true },
        { name: 'fullName', label: 'Full Name', type: 'text', placeholder: "BALAVIGNESH A", required: true },
        { name: 'email', label: 'Email', type: 'email', placeholder: "bala@example.com", required: true },
        { name: 'phone', label: 'Phone Number', type: 'tel', placeholder: "+91 9952876478", required: true },
    ...
    eventRegistration: [
        { name: 'password', label: 'Password', type: 'password', placeholder: "Enter a secure password", required: true, span: true },
        { name: 'name', label: 'Name', type: 'text', placeholder: "BALAVIGNESH A", required: true },
        { name: 'email', label: 'Email', type: 'email', placeholder: "bala@example.com", required: true },
        { name: 'phone', label: 'Phone Number', type: 'tel', placeholder: "+91 9952876478", required: true },
